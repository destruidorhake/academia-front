...
@Component({
    ...
    imports: [RouterOutlet, SideBarComponent, CommonModule, RouterOutlet, RouterLink, RouterLinkActive, SideBarComponent],
})
export class AppComponent {
  ...
  public evaluateNavbarVisibility(url: string): void {
  ...
  public  updateSidebarVisibility(shouldShow: boolean): void {
      if (!shouldShow) {
